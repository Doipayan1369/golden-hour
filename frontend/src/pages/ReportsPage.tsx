...
export const ReportsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-8 pb-12 animate-fadeIn">
      ...
      {/* Export / PDF Generator Modal */}
      {showExportModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 space-y-6 shadow-2xl border border-slate-200 animate-fadeIn">
      ...
      {showPrintModal && (
        <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="bg-white rounded-3xl max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-slate-200 overflow-hidden animate-fadeIn">
            {/* Modal Actions Bar */}
            <div className="p-4 bg-[#111317] text-white flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Shield className="w-4 h-4 text-[#D4FF00]" />
                <span className="text-xs font-black font-mono">I4C OFFICIAL COURT EVIDENCE DOSSIER</span>
              </div>
              <div className="flex items-center gap-3">
                <button
                  onClick={() => window.print()}
                  className="px-4 py-1.5 rounded-full bg-[#D4FF00] text-[#111317] text-xs font-black flex items-center gap-1.5 cursor-pointer hover:bg-lime-400 transition-colors"
                >
            ...
            <div className="p-8 overflow-y-auto space-y-6 text-slate-900 bg-white" id="printable-police-dossier">
